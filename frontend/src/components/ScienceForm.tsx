...
import { ScienceRequest, Language } from "@/types/content"
...
export default function ScienceForm({ onSubmit, isLoading }: ScienceFormProps) {
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full">
      ...
      <div className="bg-emerald-500/10 border border-emerald-400/20 rounded-xl px-4 py-3 flex flex-col gap-1">
        ...
        <p className="text-xs text-white/40">
          Usa Ollama + RAG para generar contenido con fuentes científicas reales.
          Puede tardar 2-3 minutos. Los topics en inglés dan mejores resultados.
        </p>
      </div>
