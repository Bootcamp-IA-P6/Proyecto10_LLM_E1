...
import type { GenerateRequest, Platform, Language, Model } from "@/types/content";
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full">
      ...
      <div className="flex flex-col gap-1">
        ...
        <select
          ...
          className="bg-emerald-950 border border-white/20 text-white rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-400 w-full"
        >
          <option value="groq">GROQ (online, rápido)</option>
          <option value="ollama">Ollama (local, sin límites)</option>
        </select>
        {model === "ollama" && (
